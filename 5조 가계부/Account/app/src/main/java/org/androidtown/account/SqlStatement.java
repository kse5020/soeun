...
public class SqlStatement {
    ...
    public static final String drop_sql03 = "drop table if exists BasicBudget";
    ...
    public static final String sql_02 = "create table if not exists "//0수입 1 지출
            + "Budget"
            + " (id integer PRiMARY KEY autoincrement, Date timestamp, Value integer , Name text , IO integer, Class text)";
